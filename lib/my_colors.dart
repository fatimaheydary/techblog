...
class solidcolors{
  ...
  static const Color postersubtitle=Color.fromARGB(200, 249, 245, 250);
...
class gradiantcolors{
  static const List <Color>bottomnav=[ Color.fromARGB(255, 25, 0, 94),
  Color.fromARGB(255, 68, 4, 87)];
  static const List <Color>bottomnavbackground=[ Color.fromARGB(0, 255, 255, 255),
